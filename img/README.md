# /img — photograph drop-in folder

Drop a file here with the exact filename below and it replaces the illustration
...
The published Artifact runs under a strict CSP and cannot load these files —
portraits there will always show the illustration. That is expected. The
photographs appear when `index.html` and this folder are served together from
your own domain.
